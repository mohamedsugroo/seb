class CompanyAprovalsController < ApplicationController
  ...
  def create
    ...
    if @company_aproval.save
      redirect_to @company_aproval, notice: 'Company aproval was successfully created.'
    else
      render :new
    end
  ...
  def update
    ...
    if @company_aproval.update(company_aproval_params)
      redirect_to @company_aproval, notice: 'Company aproval was successfully updated.'
    else
      render :edit
    end
  ...
  def destroy
    ...
    redirect_to root_url, notice: 'Company aproval was successfully destroyed.'
  end
  ...
  private
    ...
    def company_aproval_params
      params.require(:company_aproval).permit(:name, :admin_id, :note)
    end
end
