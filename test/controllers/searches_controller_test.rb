...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { keyword: @search.keyword, location: @search.location } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { keyword: @search.keyword, location: @search.location } }
